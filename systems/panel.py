    ...
    def _create_life_card(self, blood: int) -> ft.Container:
        ...
        return ft.Container(
            content=ft.Column(
                controls=[
                    ft.Container(
                        content=ft.Icon(ft.icons.FAVORITE, color="white", size=40),
                        margin=ft.margin.only(bottom=10),
                    ),
                    ft.Text("剩余血量", size=14, color="white", weight=ft.FontWeight.W_500),
                    ft.Text(
                        f"{blood:,}",
                        size=40,
                    ...
                    ft.Text("点", size=14, color="white", opacity=0.9),
                ],
            ...
            gradient=ft.LinearGradient(
                ...
                colors=ThemeConfig.LIFE_GRADIENT,
            ),
